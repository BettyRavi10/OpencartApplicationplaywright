        ...
        - generic [ref=e87]:
          ...
          - generic [ref=e91]:
            - generic [ref=e92]:
              ...
              - textbox "E-Mail Address" [ref=e94]: betty@gmail.com.com
            - generic [ref=e95]:
              - generic [ref=e96]: Password
              - textbox "Password" [ref=e97]: Jesusbetty$77
...
```ts
  ...
  39 |             expect(errorMessage).toContain('Warning: Your account has exceeded allowed number of login attempts. Please try again in 1 hour.');
  40 |         }
  41 |     })
  42 | 
  43 | }
...
> 71 |             expect(isLoggedIn).toBeTruthy();
  ...
  77 |             expect(errorMessage).toContain('Warning: Your account has exceeded allowed number of login attempts. Please try again in 1 hour.');    
  78 |         }
  79 |     })
  80 | 
  81 | }
